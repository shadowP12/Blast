...
namespace blast {
    ...
    public:
        ...
        void BufferCopyToBuffer(const GfxBufferCopyToBufferRange& range) override;

        void ImageCopyToImage(const GfxImageCopyToImageRange& range) override;

        void BufferCopyToImage(const GfxBufferCopyToImageRange& range) override;
